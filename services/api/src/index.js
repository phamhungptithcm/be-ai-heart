export const apiManifest = {
  ...
  endpoints: [
    ...
    "/api/domain-packs/:packId/layers",
    "/api/domain-packs/:packId/overlays",
    "/api/domain-packs/:packId/build-options",
    "/api/domain-packs/:packId/validate",
    "/api/domain-packs/:packId/conflicts",
    "/api/domain-packs/:packId/generate",
    "/api/domain-packs/:packId/artifacts",
    "/api/domain-packs/:packId/artifacts/:artifactId",
    "/api/domain-packs/:packId/sync",
    "/api/documents",
    ...
    "/api/models",
    "/api/models/providers/:providerId/refresh",
    "/api/model-settings",
    "/api/model-provider-keys",
    "/api/model-provider-keys/:providerId",
    "/api/model-provider-keys/:providerId/test",
    "/api/chat/commands",
    "/api/chat/commands/:commandId",
    "/api/chat/sessions",
