...
export const PORTAL_PERMISSIONS = Object.freeze({
  ...
  contextPacksRead: "portal.context_packs.read",
  contextPacksWrite: "portal.context_packs.write",
  documentsRead: "portal.documents.read",
  benchmarksRead: "portal.benchmarks.read",
  benchmarksWrite: "portal.benchmarks.write",
  chatRead: "portal.chat.read",
  chatWrite: "portal.chat.write",
  connectRead: "portal.connect.read",
  modelsRead: "portal.models.read",
  modelsWrite: "portal.models.write",
...
const PORTAL_ROLE_PERMISSIONS = Object.freeze({
  org_admin: [
    ...
    PORTAL_PERMISSIONS.contextPacksRead,
    PORTAL_PERMISSIONS.contextPacksWrite,
    PORTAL_PERMISSIONS.documentsRead,
    PORTAL_PERMISSIONS.benchmarksRead,
    PORTAL_PERMISSIONS.benchmarksWrite,
    PORTAL_PERMISSIONS.chatRead,
    PORTAL_PERMISSIONS.chatWrite,
    PORTAL_PERMISSIONS.connectRead,
    PORTAL_PERMISSIONS.modelsRead,
    PORTAL_PERMISSIONS.modelsWrite,
...
export const PORTAL_NAVIGATION_GROUPS = Object.freeze([
  {
    label: "Workspace",
    href: "/",
    meta: "Repos and memory",
    eyebrow: "Customer workspace",
    description: "Repository memory, docs, diagrams, and sync truth.",
    summary: "See what BeHeart knows, what is stale, and where to act next.",
    items: [
      { href: "/", label: "Home", meta: "Health and next action", icon: "overview", required_permission: PORTAL_PERMISSIONS.overviewRead },
      { href: "/repositories", label: "Repositories", meta: "Synced repo profiles", icon: "repositories", required_permission: PORTAL_PERMISSIONS.repositoriesRead },
      { href: "/graph", label: "Graph", meta: "Live code relationships", icon: "repositories", required_permission: PORTAL_PERMISSIONS.repositoriesRead },
      { href: "/diagrams", label: "Diagrams", meta: "Generated Mermaid views", icon: "documents", required_permission: PORTAL_PERMISSIONS.repositoriesRead },
      { href: "/documents", label: "Docs", meta: "Specs and business intent", icon: "documents", required_permission: PORTAL_PERMISSIONS.documentsRead },
      { href: "/context-packs", label: "Context Packs", meta: "Task-ready memory", icon: "documents", required_permission: PORTAL_PERMISSIONS.contextPacksRead },
      { href: "/domain-packs", label: "Domain Packs", meta: "Vertical overlays", icon: "documents", required_permission: PORTAL_PERMISSIONS.contextPacksRead },
      { href: "/workspaces", label: "Workspaces", meta: "Tenant sync map", icon: "overview", required_permission: PORTAL_PERMISSIONS.overviewRead },
    ],
  },
  {
    label: "AI Operations",
    href: "/workbench",
    meta: "Chat, models, CLI",
    eyebrow: "Agent workflow",
    description: "Allowlisted commands, models, and CLI connection.",
    summary: "Run AI workflows without browser shell access or hidden model spend.",
    items: [
      { href: "/workbench", label: "Workbench", meta: "Scoped commands", icon: "usage", required_permission: PORTAL_PERMISSIONS.chatRead },
      { href: "/models", label: "Models", meta: "Presets and budgets", icon: "settings", required_permission: PORTAL_PERMISSIONS.modelsRead },
      { href: "/connect", label: "CLI / MCP", meta: "Local setup", icon: "access", required_permission: PORTAL_PERMISSIONS.connectRead },
    ],
  },
  {
    label: "Value",
    ...
    eyebrow: "Value proof",
    description: "Benchmark evidence, usage truth, and billing.",
    summary: "Separate measured savings from estimates and live usage.",
    items: [
  ...
  },
  {
    ...
    description: "Access, policy warnings, audit, and settings.",
    summary: "Keep tenant governance separate from internal admin controls.",
    items: [
      { href: "/policies", label: "Policies / Governance", meta: "Guardrails and warnings", icon: "policy", required_permission: PORTAL_PERMISSIONS.policiesRead },
      { href: "/team", label: "Team", meta: "Members and roles", icon: "access", required_permission: PORTAL_PERMISSIONS.teamAccessRead },
...
export const PORTAL_ROUTE_PERMISSIONS = Object.freeze({
  "/": PORTAL_PERMISSIONS.overviewRead,
  "/workspaces": PORTAL_PERMISSIONS.overviewRead,
  "/repositories": PORTAL_PERMISSIONS.repositoriesRead,
  "/context-packs": PORTAL_PERMISSIONS.contextPacksRead,
  "/domain-packs": PORTAL_PERMISSIONS.contextPacksRead,
  "/documents": PORTAL_PERMISSIONS.documentsRead,
  "/graph": PORTAL_PERMISSIONS.repositoriesRead,
  "/diagrams": PORTAL_PERMISSIONS.repositoriesRead,
  "/workbench": PORTAL_PERMISSIONS.chatRead,
  "/models": PORTAL_PERMISSIONS.modelsRead,
  "/connect": PORTAL_PERMISSIONS.connectRead,
  ...
  "/team": PORTAL_PERMISSIONS.teamAccessRead,
